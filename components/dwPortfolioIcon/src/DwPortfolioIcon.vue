 ...
 * @LastEditTime: 2022-01-12 16:13:52
...
<script lang="ts">
import { reactive, provide, computed, defineComponent } from 'vue'
...
// import { defineProps, reactive, provide, computed, defineComponent } from 'vue'
// import { use } from 'echarts/core'
// import { CanvasRenderer } from 'echarts/renderers'
...
// // ismobile.value = browser.versions.mobile
// // ehcarts版本
// // const echartsVersion = ref(version)
// // 主题
// provide(THEME_KEY, props.themeKey)
// // 最大回撤位置
// const maxIndex = computed(() => {
